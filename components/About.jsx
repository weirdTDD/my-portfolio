...
AI-driven applications. </p>
                ...
                <ul className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
                    {infoList.map(({icon,iconDark,title,description},index) => (
                        <li className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-lg' key={index} >
                ...
                <h4 className='my-6 font-semibold text-gray-700 font-Ovo'>Tools I Use</h4>
