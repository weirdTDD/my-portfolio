  ...
  return (
    <div className='mt-20'>
      ...
      <div className='text-center sm:flex items-center justify-between border-t border-gray-400 py-6 mx-[10%] mt-12'>
        <p className='text-center text-sm text-gray-600 mb-4'>© 2025 Edward Morhe. All rights reserved.</p>
        <ul className='flex items-center gap-10 justify-center sm:mt-0 mt-4'>
            <li><a target='_blank' href="www.linkedin.com/in/edward-morhe-0bab1224b"></a>LinkedIn</li>
            <li><a target='_blank' href="https://github.com/weirdTDD"></a>Github</li>
        </ul>
      </div>
    </div>
  )
