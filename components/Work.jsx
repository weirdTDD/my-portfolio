...
const Work = ({isDarkmode}) => {
  ...
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='mb-12 mt-5 font-Ovo max-w-2xl mx-auto text-center'>Welcome to my web development portfolio, where you can explore a collection of projects showcasing my expertise not just in front-end development but in Full-Stack Web Development as a whole.</motion.p>
